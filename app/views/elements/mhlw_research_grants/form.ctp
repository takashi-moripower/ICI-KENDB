...
<td><?php echo $datePicker->picker('this_year_advance_application_date', array('empty'=>true)); ?></td>
<td>&nbsp;</td>
</tr>
<tr>
<td><?php echo $this->KendbForm->input('moving_history'); ?></td>
<td><?php echo $this->KendbForm->input('commission_coi_check'); ?></td>
...
<td>&nbsp;</td>
<td>&nbsp;</td>
<td style="border-right:3px solid gray;">&nbsp;</td>
</tr>
...
<td><?php echo $this->KendbForm->input('this_year_total_at_decision', array('class' => 'autocalc autocalcresult')); ?></td>
<td><?php echo $this->KendbForm->input('this_year_direct_at_decision', array('class' => 'autocalc')); ?></td>
<td><?php echo $this->KendbForm->input('this_year_indirect_at_decision', array('class' => 'autocalc')); ?></td>
<td>&nbsp;</td>
<td>&nbsp;</td>
</tr>
<tr>
...
<tr>
<td colspan="6"><?php echo $this->KendbForm->input('research_assignment'); ?></td>
<tr>
<tr>
...
<tr>
<td colspan="6"><?php echo $this->KendbForm->input('contribution_remarks', array('rows' => 10, 'cols' => 120)); ?></td>
</tr>
<tr>
...
<tr>
<td colspan="6"><?php echo $this->KendbForm->input('remarks', array('rows' => 10, 'cols' => 120)); ?></td>
</tr>
<tr>
...
<?php echo $javascript->link('mhlw_research_grant'); ?>
