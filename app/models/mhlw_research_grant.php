 ...
 * @link	  None
 */
class MhlwResearchGrant extends AppModel {

    var $name = 'MhlwResearchGrant';
    var $actsAs = array('Search.Searchable', 'SoftDeletable' => array('field' => 'disabled', 'find' => false));
    var $download_file_prefix = "kaken_koro";
    var $validate = array(
        'id' => array(
            'numeric' => array(
                'rule' => array('numeric'),
    ...
    function beforeSave($options = array()) {
        ...
        return $this->setUserInfo("MhlwResearchGrant");
    }
