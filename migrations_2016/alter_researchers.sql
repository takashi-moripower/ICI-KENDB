...
IF @_exists= 0 THEN
    ...
    ALTER TABLE `researchers` ALTER COLUMN `institute_code` DROP DEFAULT;
    ALTER TABLE `researchers` ALTER COLUMN `school_code` DROP DEFAULT;
    ALTER TABLE `researchers` ALTER COLUMN `course_code` DROP DEFAULT;
