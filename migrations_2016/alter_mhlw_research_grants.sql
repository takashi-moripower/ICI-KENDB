...
IF @_exists= 0 THEN
    ALTER TABLE `mhlw_research_grants`
    ...
    ALTER TABLE `mhlw_research_grants` ALTER COLUMN `institute_code` DROP DEFAULT;
    ALTER TABLE `mhlw_research_grants` ALTER COLUMN `school_code` DROP DEFAULT;
    ALTER TABLE `mhlw_research_grants` ALTER COLUMN `course_code` DROP DEFAULT;
