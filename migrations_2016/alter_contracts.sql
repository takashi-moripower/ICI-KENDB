...
IF @_exists= 0 THEN
    ...
    ALTER TABLE `contracts` ALTER COLUMN `institute_code` DROP DEFAULT;
    ALTER TABLE `contracts` ALTER COLUMN `school_code` DROP DEFAULT;
    ALTER TABLE `contracts` ALTER COLUMN `course_code` DROP DEFAULT;
