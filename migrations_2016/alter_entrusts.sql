...
IF @_exists= 0 THEN
    ...
    ALTER TABLE `entrusts` ALTER COLUMN `institute_code` DROP DEFAULT;
    ALTER TABLE `entrusts` ALTER COLUMN `school_code` DROP DEFAULT;
    ALTER TABLE `entrusts` ALTER COLUMN `course_code` DROP DEFAULT;
