...
IF @_exists= 0 THEN
    ...
    ALTER TABLE `donations` ALTER COLUMN `institute_code` DROP DEFAULT;
    ALTER TABLE `donations` ALTER COLUMN `school_code` DROP DEFAULT;
    ALTER TABLE `donations` ALTER COLUMN `course_code` DROP DEFAULT;
