...
IF @_exists= 0 THEN
    ...
    ALTER TABLE `adoptions` ALTER COLUMN `institute_code` DROP DEFAULT;
    ALTER TABLE `adoptions` ALTER COLUMN `school_code` DROP DEFAULT;
    ALTER TABLE `adoptions` ALTER COLUMN `course_code` DROP DEFAULT;
